...
public class PicasaAlbumService {
  ...
  public void uploadPhoto(String fileName, String mimeType, String[] tags, InputStream photo) {
    uploadPhoto(oAuth2Service.refreshToken(), fileName, mimeType, tags, photo);
  }

  public void uploadPhoto(AccessToken token, String fileName, String mimeType, String[] tags, InputStream photo) {
    ...
    picasaService.updatePhotoMedaInf(
      ...
      this.albumId,
      entry.getPhotoId(),
      createMetaDataXmlPart(String.join(", ", tags))
    );
  }
  ...
  private TypedByteArray createMetaDataXmlPart(String tags) {
