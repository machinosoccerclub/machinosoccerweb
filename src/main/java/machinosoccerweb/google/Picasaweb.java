...
public class Picasaweb {
  ...
  public void uploadPhoto(String fileName, String description, String mimeType,
                          String[] tags, InputStream photo) {
    uploadPhoto(googleOAuth2.refreshToken(), fileName, description, mimeType, tags, photo);
  }

  public void uploadPhoto(AccessToken token, String fileName, String description,
                          String mimeType, String[] tags, InputStream photo) {
